...
| [gpt-image-gen](skills/gpt-image-gen/) | 通过 apimart.ai 的 GPT-Image-2 生成或改写图片 | `scripts/`, `references/`, `config.example.json` |
...
| [shangtou-changwen](skills/shangtou-changwen/) | 将中文草稿改写成上头、毒舌、网感强的长帖文风 | `references/` |
